      ...
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="rounded border border-outline-variant/30 bg-surface-container-low p-lg">
          ...
          <div className="grid grid-cols-2 gap-sm sm:grid-cols-3 lg:grid-cols-4">
            ...
            <Link href="/app/admin/logs" className="flex items-center gap-sm rounded bg-surface-container px-sm py-xs text-body-sm text-on-surface transition-colors hover:bg-surface-container-high">
