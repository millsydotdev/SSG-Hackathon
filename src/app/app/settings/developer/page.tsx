    ...
    <div className="mx-auto max-w-2xl p-lg">
      ...
      <div className="rounded border border-outline-variant/30 bg-surface-container p-lg">
        ...
        <div className="flex flex-col gap-xs font-mono text-[10px] text-on-surface-variant">
          ...
          <div className="flex justify-between"><span>Supabase</span><span className="text-on-surface">{config.supabase.url ? "Connected" : "Not configured"}</span></div>
          <div className="flex justify-between"><span>Redis</span><span className="text-on-surface">{config.redis.url ? "Configured" : "Not configured"}</span></div>
        </div>
      </div>

      <div className="mt-lg rounded border border-outline-variant/30 bg-surface-container p-lg">
        <h2 className="mb-md font-mono text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">Database</h2>
        <p className="font-mono text-[10px] text-on-surface-variant">Supabase PostgreSQL · migrations in supabase/migrations/</p>
      </div>
    </div>
  );
}
